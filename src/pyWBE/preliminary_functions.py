...
def plot_time_series(series_x: pd.Series, series_y: pd.Series[Union[float, int]], plot_type: str = "linear") -> None:
    """
...
def calculate_weekly_concentration_perc_change(conc_data: pd.Series[Union[float, int]]) -> pd.Series:
    """
